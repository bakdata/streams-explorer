...
export type FrontendStaticGetProps = Omit<GetProps<FrontendStaticGetResponse, unknown, void, void>, "path">;
...
export type UseFrontendStaticGetProps = Omit<UseGetProps<FrontendStaticGetResponse, unknown, void, void>, "path">;

/**
 * Frontend
 */
export const useFrontendStaticGet = (props: UseFrontendStaticGetProps) => useGet<FrontendStaticGetResponse, unknown, void, void>(encode`/static`, props);


export interface FrontendGetResponse {}

export type FrontendGetProps = Omit<GetProps<FrontendGetResponse, unknown, void, void>, "path">;

/**
 * Frontend
 */
export const FrontendGet = (props: FrontendGetProps) => (
  <Get<FrontendGetResponse, unknown, void, void>
    path={encode`/`}
...
export type UseFrontendGetProps = Omit<UseGetProps<FrontendGetResponse, unknown, void, void>, "path">;

/**
 * Frontend
 */
export const useFrontendGet = (props: UseFrontendGetProps) => useGet<FrontendGetResponse, unknown, void, void>(encode`/`, props);
 ...
 * Update
 */
export const useUpdateApiUpdatePost = (props: UseUpdateApiUpdatePostProps) => useMutate<UpdateApiUpdatePostResponse, unknown, void, void, void>("POST", encode`/api/update`, props);
 ...
 * Get Positioned Graph
 */
export const useGetPositionedGraphApiGraphGet = (props: UseGetPositionedGraphApiGraphGetProps) => useGet<Graph, HTTPValidationError, GetPositionedGraphApiGraphGetQueryParams, void>(encode`/api/graph`, props);
 ...
 * Get Pipelines
 */
export const useGetPipelinesApiPipelinesGet = (props: UseGetPipelinesApiPipelinesGetProps) => useGet<Pipelines, unknown, void, void>(encode`/api/pipelines`, props);
 ...
 * Get Node Info
 */
export const useGetNodeInfoApiNodeNodeIdGet = ({node_id, ...props}: UseGetNodeInfoApiNodeNodeIdGetProps) => useGet<NodeInformation, HTTPValidationError, void, GetNodeInfoApiNodeNodeIdGetPathParams>((paramsInPath: GetNodeInfoApiNodeNodeIdGetPathParams) => encode`/api/node/${paramsInPath.node_id}`, {  pathParams: { node_id }, ...props });
 ...
 * Get Metrics
 */
export const useGetMetricsApiMetricsGet = (props: UseGetMetricsApiMetricsGetProps) => useGet<Metric[], unknown, void, void>(encode`/api/metrics`, props);
